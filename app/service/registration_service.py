...
class RegistrationService:
    ...
    def register(self, student_id : int, course_id : int, first_checker : RequirementChecker) -> Notification:
        ...
        create_registration, notification = first_checker.check_requirements(student, course)
